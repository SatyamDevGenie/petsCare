    ...
    <div className="container mx-auto px-4 sm:px-6 py-10 sm:py-16">
      ...
      >
        ...
        <p className="mt-4 sm:mt-6 text-sm sm:text-lg text-gray-600 max-w-lg mx-auto">
          Explore our collection of adorable pets and give them the love and care they deserve.
        </p>
      </motion.div>
      ...
      <motion.div
        className="text-center bg-gray-50 p-4 sm:p-10 mt-12 sm:mt-24 rounded-lg shadow-lg mx-2 sm:mx-4"
      ...
      >
        ...
        <p className="mt-3 sm:mt-6 text-gray-600 max-w-lg mx-auto font-medium text-sm sm:text-base text-justify">
          ...
          provide discount offers for particular pets services as per seasonal / trending change
        </p>
      </motion.div>
      ...
      <motion.div
        className="mt-12 sm:mt-24 px-4 sm:px-10 py-10 bg-gray-50 rounded-lg shadow-md"
        initial="hidden"
        whileInView="visible"
        variants={containerVariants}
        viewport={{ once: true }}
